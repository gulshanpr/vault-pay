...
contract MerchantRegistryTest is Test {
    ...
    function test_RegisterMerchant_Success_USDC_ONLY() public {
        ...
        MerchantRegistry.MerchantConfig memory config = registry.getConfig(
            merchant1
        );
        ...
        assertEq(
            uint8(config.mode),
            uint8(MerchantRegistry.PayoutMode.USDC_ONLY)
        );
    ...
    function test_RegisterMerchant_Success_SHARES_ONLY() public {
        ...
        assertEq(
            uint8(config.mode),
            uint8(MerchantRegistry.PayoutMode.SHARES_ONLY)
        );
    ...
    function test_CompleteWorkflow() public {
        ...
        MerchantRegistry.MerchantConfig memory config1 = registry.getConfig(
            merchant1
        );
        ...
        MerchantRegistry.MerchantConfig memory config2 = registry.getConfig(
            merchant2
        );
    ...
    function testFuzz_RegisterMerchant_ValidProtocolFee(
    ...
    function testFuzz_RegisterMerchant_InvalidProtocolFee(
        uint16 protocolFeeBps
    ) public {
        vm.assume(protocolFeeBps > 1000);
